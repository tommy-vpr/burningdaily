  ...
  return (
    <div className="px-8">
      ...
      <Swiper
        ...
        className={`h-[480px] xl:h-[520px] 2xl:h-[600px] p-4`}>
        {arrivals.map((item) => (
          <SwiperSlide className="text-center flex justify-center flex-col items-center gap-2 text-[#666]">
            ...
            <div className="flex gap-4 justify-center mt-8">
              <button className="rounded outline outline-[1px] outline-gray-300 w-full">
                Quick View
              </button>
              <button className="rounded bg-[#327739] text-white text-md p-2 w-full">
                Add to cart
              </button>
            </div>
          </SwiperSlide>
